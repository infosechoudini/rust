...
use crate::hash::xxh64_common::{CHUNK_SIZE, PRIME_1, PRIME_2, PRIME_3, PRIME_4, PRIME_5, round, avalanche, merge_round};
...
#[unstable(feature = "hashmap_xxhash", issue = "none")]
impl super::BuildHasher for Xxh64Builder {
    type Hasher = Xxh64;
